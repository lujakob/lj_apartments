...
namespace LuJa\LjApartment\ViewHelpers;
...
class ApartmentNavViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
	...
	public function render() {
		...
		$apartments = $this->apartmentRepository->findAllForViewHelper();
